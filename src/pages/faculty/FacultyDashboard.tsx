...
const navItems = [
  { id: "", label: "Home", icon: Home, path: "/dashboard/faculty" },
  { id: "courses", label: "Assigned Courses", icon: BookOpen, path: "/dashboard/faculty/courses" },
  { id: "attendance", label: "Attendance", icon: Calendar, path: "/dashboard/faculty/attendance" },
  { id: "sessions", label: "Attendance Sessions", icon: Clock, path: "/dashboard/faculty/sessions" },
  { id: "take-attendance", label: "Take Attendance", icon: ClipboardCheck, path: "/dashboard/faculty/take-attendance" },
  { id: "profile", label: "Profile", icon: User, path: "/dashboard/faculty/profile" },
];
...
export default function FacultyDashboard() {
  ...
  const getCurrentPageTitle = () => {
    const currentItem = navItems.find(item =>
      ...
      (item.id && location.pathname.startsWith(`/dashboard/faculty/${item.id}`))
    );
