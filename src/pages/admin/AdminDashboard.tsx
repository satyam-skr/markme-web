...
const navItems = [
  { id: "", label: "Dashboard", icon: Home, path: "/dashboard/admin" },
  ...
  { id: "courses", label: "Courses", icon: BookOpen, path: "/dashboard/admin/courses" },
  { id: "faculty-assignment", label: "Faculty Assignment", icon: UserCheck, path: "/dashboard/admin/faculty-assignment" },
  { id: "student-registration", label: "Student Registration", icon: ClipboardList, path: "/dashboard/admin/student-registration" },
  { id: "attendance", label: "Attendance", icon: Calendar, path: "/dashboard/admin/attendance" },
...
export default function AdminDashboard() {
  ...
  const getCurrentPageTitle = () => {
    const currentItem = navItems.find(item => 
      ...
      (item.id && location.pathname.startsWith(`/dashboard/admin/${item.id}`))
    );
